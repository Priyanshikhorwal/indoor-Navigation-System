                    ...
                    <div className="bg-white dark:bg-darkCard p-6 rounded-xl shadow border border-gray-100 dark:border-gray-800">
                        ...
                        <form onSubmit={handleAddFloor} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="col-span-full">
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Upload Map Image (Optional)</label>
                                <input type="file" onChange={e => setMapFile(e.target.files[0])} accept="image/*" className="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r from-primary to-primary-light/10 file:text-primary hover:file:bg-gradient-to-r from-primary to-primary-light/20 transition-colors" />
                            </div>
                                ...
                                <tbody>
                                    {floors.map(f => (
                                        <tr key={f.id} className="border-b hover:bg-gray-50/55 dark:bg-darkHover/55 transition-colors">
                                            ...
                                            <td className="p-3.5 text-sm">
                                                {f.mapImageUrl ? <a href={`http://localhost:8082${f.mapImageUrl}`} target="_blank" rel="noreferrer" className="text-blue-500 hover:underline">View Map</a> : <span className="text-gray-300 italic">None</span>}
                                            </td>
                                            <td className="p-3.5">
            ...
            {activeTab === 'connections' && (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 bg-white dark:bg-darkCard p-6 rounded-2xl shadow border border-gray-100 dark:border-gray-800 flex flex-col space-y-4">
                        ...
                        {/* Node map container */}
                        <div className="relative border border-gray-100 dark:border-gray-800 rounded-2xl bg-gray-50 dark:bg-darkHover overflow-hidden aspect-[8/4.8]">
                            <svg 
                                ref={svgRef}
                                    ...
                                    <div className="mt-4 p-3 bg-white dark:bg-darkCard rounded-lg border border-gray-200 dark:border-gray-700">
                                        ...
                                        <div className="max-h-[150px] overflow-y-auto space-y-1">
                                            {testRouteResult.steps.map((step, idx) => (
                                                <div key={idx} className="text-[10px] text-gray-600 dark:text-gray-400 flex gap-2">
