        ...
        <div className="container mx-auto py-8 px-4 max-w-7xl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure and manage building room grids and network connection weights</p>
                </div>
                ...
                <div className="flex bg-gradient-to-br from-secondary to-secondary-dark p-1 rounded-xl w-fit">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'buildings'
                                ? 'bg-gradient-to-r from-primary to-primary-light text-white shadow-soft'
                                : 'text-primary/70 hover:text-primary hover:bg-white/50 dark:hover:bg-darkCard/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'floors'
                                ? 'bg-gradient-to-r from-primary to-primary-light text-white shadow-soft'
                                : 'text-primary/70 hover:text-primary hover:bg-white/50 dark:hover:bg-darkCard/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'locations'
                                ? 'bg-gradient-to-r from-primary to-primary-light text-white shadow-soft'
                                : 'text-primary/70 hover:text-primary hover:bg-white/50 dark:hover:bg-darkCard/50'
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-bold flex items-center gap-2 transition-all ${activeTab === 'connections'
                                ? 'bg-gradient-to-r from-primary to-primary-light text-white shadow-soft'
                                : 'text-primary/70 hover:text-primary hover:bg-white/50 dark:hover:bg-darkCard/50'
                            }`}
                    >
            ...
            {activeTab === 'buildings' && (
                <div className="space-y-6 animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-darkCard p-6 rounded-xl shadow border border-gray-100 dark:border-gray-800">
                        ...
                        <form onSubmit={handleAddBuilding} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <input type="text" placeholder="Building Name" required value={newBuilding.name} onChange={e => setNewBuilding({ ...newBuilding, name: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                            <input type="text" placeholder="Description" value={newBuilding.description} onChange={e => setNewBuilding({ ...newBuilding, description: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                    ...
                    <div className="bg-white dark:bg-darkCard p-6 rounded-xl shadow border border-gray-100 dark:border-gray-800">
                        <h2 className="text-xl font-bold text-primary mb-4 border-b border-gray-100 dark:border-gray-800 pb-4">Manage Buildings</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {buildings.map(b => (
                                <div key={b.id} className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 hover:shadow-soft transition-shadow relative group bg-gray-50/50">
                                    ...
                                    <h3 className="font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2"><Building className="w-4 h-4 text-primary" /> {b.name}</h3>
                                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{b.description || 'No description'}</p>
                                    <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-400 font-mono">
                                        Building ID: #{b.id}
                                    </div>
                                </div>
                            ))}
                            {buildings.length === 0 && (
                                <p className="text-gray-500 dark:text-gray-400 text-sm col-span-full py-8 text-center">No buildings configured. Create one above.</p>
                            )}
                        </div>
                    </div>

                    {/* CONNECTIONS TABLE */}
                    <div className="lg:col-span-12 bg-white dark:bg-darkCard p-6 rounded-2xl shadow border border-gray-100 dark:border-gray-800 mt-6">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 dark:border-gray-800 pb-4 mb-4">
                            <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg flex items-center gap-1.5">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-darkCard/80 border-b">
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">ID</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Source Location</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Destination Location</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Distance</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Accessible</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {connections.filter(c => {
                                        ...
                                        <tr key={conn.id} className="border-b hover:bg-gray-50/55 dark:bg-darkHover/55 transition-colors">
                                            <td className="p-3.5 text-sm text-gray-500 dark:text-gray-400">#{conn.id}</td>
                                            <td className="p-3.5 text-sm font-bold text-gray-800 dark:text-gray-100">{conn.sourceLocation.name}</td>
                                            <td className="p-3.5 text-sm font-bold text-gray-800 dark:text-gray-100">{conn.destinationLocation.name}</td>
                                            <td className="p-3.5 text-sm font-mono text-gray-600 dark:text-gray-400">{conn.distance.toFixed(1)}</td>
                ...
                <div className="space-y-6 animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-darkCard p-6 rounded-xl shadow border border-gray-100 dark:border-gray-800">
                        ...
                        <form onSubmit={handleAddFloor} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <select required value={newFloor.buildingId} onChange={e => setNewFloor({ ...newFloor, buildingId: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                <option value="">Select Building...</option>
                                {buildings.map(b => <option key={b.id} value={b.id}>{b.name}</option>)}
                            </select>
                            <input type="text" placeholder="Floor Name (e.g. Ground Floor)" required value={newFloor.floorName} onChange={e => setNewFloor({ ...newFloor, floorName: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                            <input type="number" placeholder="Floor Number (e.g. 0, 1, -1)" required value={newFloor.floorNumber} onChange={e => setNewFloor({ ...newFloor, floorNumber: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />

                            <div className="col-span-full">
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Upload Map Image or SVG (Optional)</label>
                                <p className="text-xs text-blue-500 mb-2 font-semibold">✨ Note: Uploading an .svg file will automatically generate graph nodes from shapes!</p>
                                <input type="file" onChange={e => setMapFile(e.target.files[0])} accept="image/*,.svg" className="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r from-primary to-primary-light/10 file:text-primary hover:file:bg-gradient-to-r from-primary to-primary-light/20 transition-colors" />
                            </div>
                    ...
                    <div className="bg-white dark:bg-darkCard p-6 rounded-xl shadow border border-gray-100 dark:border-gray-800">
                        <h2 className="text-xl font-bold text-primary mb-4 border-b border-gray-100 dark:border-gray-800 pb-4">Manage Floors</h2>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-darkCard/80 border-b">
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Building</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Floor Name</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Floor Number</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Map Image</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {floors.map(f => (
                                        <tr key={f.id} className="border-b hover:bg-gray-50/55 dark:bg-darkHover/55 transition-colors">
                                            <td className="p-3.5 text-sm font-bold text-gray-800 dark:text-gray-100">{f.building?.name || 'Unknown'}</td>
                                            <td className="p-3.5 text-sm font-bold text-gray-800 dark:text-gray-100">{f.floorName}</td>
                            ...
                            {floors.length === 0 && (
                                <p className="text-center py-10 text-gray-500 dark:text-gray-400 text-sm">No floors configured.</p>
                            )}
                        </div>
                    </div>
            ...
            {activeTab === 'locations' && (
                <div className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-darkCard p-4 rounded-xl shadow border border-gray-100 dark:border-gray-800 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="p-2 bg-gradient-to-r from-primary to-primary-light/10 text-primary rounded-lg">
                                <Sparkles className="w-5 h-5" />
                            </div>
                            <div>
                                <h3 className="font-bold text-gray-800 dark:text-gray-100">Add a New Room Location</h3>
                                <p className="text-xs text-gray-500 dark:text-gray-400">Insert coordinate coordinates directly into database grids</p>
                            </div>
                        </div>
                        <button
                    ...
                    {showAddForm && (
                        <div className="bg-white dark:bg-darkCard p-6 rounded-xl shadow border border-gray-100 dark:border-gray-800 animate-in fade-in slide-in-from-top-4 duration-200">
                            ...
                            <form onSubmit={handleAddLocation} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <input type="text" placeholder="Location Name" required value={newLoc.name} onChange={e => setNewLoc({ ...newLoc, name: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                                <input type="text" placeholder="Description" value={newLoc.description} onChange={e => setNewLoc({ ...newLoc, description: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                                <select required value={newLoc.floorId} onChange={e => setNewLoc({ ...newLoc, floorId: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                    <option value="">Select Floor...</option>
                                    {floors.map(f => (
                                        <option key={f.id} value={f.id}>{f.building?.name} - {f.floorName}</option>
                                    ))}
                                </select>
                                <select required value={newLoc.type} onChange={e => setNewLoc({ ...newLoc, type: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                ...
                                <input type="number" placeholder="X Coordinate (Integer)" required value={newLoc.xCoordinate} onChange={e => setNewLoc({ ...newLoc, xCoordinate: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                                <input type="number" placeholder="Y Coordinate (Integer)" required value={newLoc.yCoordinate} onChange={e => setNewLoc({ ...newLoc, yCoordinate: e.target.value })} className="p-2.5 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 text-sm w-full outline-none focus:ring-2 focus:ring-primary focus:border-transparent" />
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-darkCard/80 border-b">
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">ID</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Name</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Coordinates (X, Y)</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Floor Elevation</th>
                                        <th className="p-3.5 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {filteredLocations.map(loc => (
                                        <tr key={loc.id} className="border-b hover:bg-gray-50/55 dark:bg-darkHover/55 transition-colors">
                                            <td className="p-3.5 text-sm text-gray-500 dark:text-gray-400">#{loc.id}</td>
                                            <td className="p-3.5 text-sm font-bold text-gray-800 dark:text-gray-100">{loc.name}</td>
                                            <td className="p-3.5 text-sm text-gray-600 dark:text-gray-400 font-mono">({loc.xCoordinate}, {loc.yCoordinate})</td>
            ...
            {activeTab === 'connections' && (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 bg-white dark:bg-darkCard p-6 rounded-2xl shadow border border-gray-100 dark:border-gray-800 flex flex-col space-y-4">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 dark:border-gray-800 pb-4">
                            <div>
                                <h3 className="text-lg font-bold text-primary">Interactive Room Connect</h3>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Click any two room circles to establish link pathways</p>
                            </div>
                                ...
                                {['All', ...uniqueFloors].map(floorId => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-lg text-xs font-bold transition-all ${activeMapFloor === floorId
                        ...
                        <div className="bg-gradient-to-br from-secondary to-secondary-dark/40 p-3 rounded-xl border border-gray-100 dark:border-gray-800 text-xs flex flex-col sm:flex-row sm:items-center justify-between gap-3 animate-in fade-in duration-200">
                            ...
                            <input
                                ...
                                className="w-full p-2 border border-gray-200 dark:border-gray-700 rounded-lg outline-none bg-white dark:bg-darkCard focus:ring-1 focus:ring-primary focus:border-transparent text-gray-700 dark:text-gray-300 text-xs font-mono"
                            />
                        </div>
                                ...
                                {locations.map(loc => {
                                    ...
                                    return (
                                        <g
                                            ...
                                            className={`cursor-grab active:cursor-grabbing transition-all duration-200 ${isVisible ? 'opacity-100' : 'opacity-15'
                                                }`}
                                        >
                    ...
                    <div className="lg:col-span-4 bg-white dark:bg-darkCard p-6 rounded-2xl shadow border border-gray-100 dark:border-gray-800 flex flex-col space-y-5">
                        <div>
                            <h3 className="font-bold text-gray-800 dark:text-gray-100 text-lg flex items-center gap-1.5"><Database className="text-accent" /> Edge SQL Generator</h3>
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Select two locations on the grid map to build SQL seeds</p>
                        </div>

                        {/* Selection summary */}
                        <div className="bg-gradient-to-br from-secondary to-secondary-dark/45 p-4 rounded-xl space-y-3 border border-gray-100 dark:border-gray-800 text-sm">
                            <div className="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-gray-700">
                                <span className="text-gray-500 dark:text-gray-400 font-semibold">Start Location (A):</span>
                                <span className="font-bold text-primary">{startNode ? startNode.name : <span className="text-gray-400 italic">Select node</span>}</span>
                            </div>
                            <div className="flex justify-between items-center pb-2 border-b border-gray-200 dark:border-gray-700">
                                <span className="text-gray-500 dark:text-gray-400 font-semibold">Target Location (B):</span>
                            ...
                            <div className="flex justify-between items-center">
                                <span className="text-gray-500 dark:text-gray-400 font-semibold">Euclidean Distance:</span>
                                <span className="font-mono font-bold text-gray-800 dark:text-gray-100">{startNode && endNode ? `${calculateDistance(startNode, endNode)} units` : '--'}</span>
                            </div>
                        </div>
                        ...
                        {startNode && endNode ? (
                            <div className="space-y-3.5">
                                ...
                                <button
                                    ...
                                    className="w-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 py-2.5 rounded-xl font-bold hover:bg-gray-200 transition-all text-sm"
                                >
                                    Cancel
                                </button>
                            ...
                            <div className="py-12 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl flex flex-col items-center justify-center text-center p-4">
                                <Compass className="w-10 h-10 text-gray-300 animate-spin" style={{ animationDuration: '4s' }} />
                                <h4 className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-3">Select Nodes to Begin</h4>
                        ...
                        {/* Route Tester */}
                        <div className="bg-gradient-to-br from-secondary to-secondary-dark/30 p-5 rounded-2xl border border-gray-100 dark:border-gray-800">
                            <h3 className="font-bold text-gray-800 dark:text-gray-100 text-sm mb-3 flex items-center gap-1.5">
                            ...
                            <div className="space-y-3">
                                ...
                                {testRouteResult && (
                                    <div className="mt-4 p-3 bg-white dark:bg-darkCard rounded-lg border border-gray-200 dark:border-gray-700">
                                        <p className="text-xs font-bold text-gray-800 dark:text-gray-100 mb-1">Resulting Path ({testRouteResult.totalDistance.toFixed(1)}m):</p>
            ...
            {editingLoc && (
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-darkCard p-6 rounded-2xl shadow-soft-lg w-full max-w-md border border-gray-100 dark:border-gray-800 animate-in fade-in zoom-in duration-200">
                        <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-primary">
                            <Edit className="text-accent" /> Edit Location
                        </h2>
                        <form onSubmit={handleEditLocation} className="space-y-4">
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Location Name</label>
                                <input
                                    type="text"
                                    required
                                    value={editingLoc.name}
                                    onChange={e => setEditingLoc({ ...editingLoc, name: e.target.value })}
                                    className="w-full p-2 border border-gray-200 dark:border-gray-700 rounded bg-white dark:bg-darkHover text-gray-800 dark:text-gray-100 focus:ring-2 focus:ring-primary focus:border-transparent outline-none"
                                />
                            </div>
                            <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">X Coordinate</label>
                                    <input
                                        type="number"
                                        required
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Y Coordinate</label>
                                    <input
                                        type="number"
                                        required
                            ...
                            <div className="flex gap-4 pt-2">
                                <button
                                    ...
                                    className="flex-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 py-2 rounded font-bold hover:bg-gray-200 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-darkCard p-6 rounded-2xl shadow-soft-lg w-full max-w-md border border-gray-100 dark:border-gray-800 animate-in fade-in zoom-in duration-200">
                        ...
                        <form onSubmit={(e) => {
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Source Node</label>
                                <input type="text" disabled value={editingConn.sourceLocation.name} className="w-full p-2 border rounded bg-gray-50 dark:bg-darkHover text-gray-500 dark:text-gray-400 outline-none" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Destination Node</label>
                                <input type="text" disabled value={editingConn.destinationLocation.name} className="w-full p-2 border rounded bg-gray-50 dark:bg-darkHover text-gray-500 dark:text-gray-400 outline-none" />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Distance (Calculated automatically on backend)</label>
                                <input type="number" step="0.1" disabled value={editingConn.distance} className="w-full p-2 border rounded bg-gray-50 dark:bg-darkHover text-gray-500 dark:text-gray-400 outline-none" />
                            </div>
                            <div className="flex items-center gap-2">
                                <input
                                    type="checkbox"
                                ...
                                />
                                <label htmlFor="accessible" className="text-sm font-semibold text-gray-700 dark:text-gray-300">Wheelchair Accessible</label>
                            </div>
                            <div className="flex gap-4 pt-2">
                                <button
                                    type="button"
